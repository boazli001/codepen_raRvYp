...
var Player = function() {
	...
	this.draw = function() {
		try {
			...
			else if (this.dir == "left_land") this.cy = 37+1;
...
function Platform() {
	...
	if (score >= 5000) this.types = [1, 4, 4, 4, 4];
	else if (score >= 2000 && score < 5000) this.types = [1, 3, 1, 3, 1, 1, 1, 3, 3, 1, 3];
	else if (score >= 1000 && score < 2000) this.types = [1, 1, 1, 3, 1, 3, 1,3 ];
	else if (score >= 500 && score < 1000) this.types = [1, 1, 3, 1, 3, 1, 3, 1, 3, 3, 1, 1, 3];
	else if (score >= 100 && score < 500) this.types = [3, 3, 3, 1, 3, 3];
	else this.types = [1];
